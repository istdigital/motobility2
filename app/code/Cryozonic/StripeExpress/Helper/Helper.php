...
namespace Cryozonic\StripeExpress\Helper;
...
class Helper
{
    ...
    {
        // Required "Stripe.js v3 + Stripe Elements"
        $active = $this->paymentsConfig->getConfigData('active');
        $activeLocation = $this->getStoreConfig('payment/cryozonic_stripeexpress/' . $location);

        return $active && $activeLocation && !$this->stripeHelper->hasSubscriptions();
    }
    ...
    {
        return (bool)$this->getStoreConfig('payment/cryozonic_stripe/use_store_currency');
    }
