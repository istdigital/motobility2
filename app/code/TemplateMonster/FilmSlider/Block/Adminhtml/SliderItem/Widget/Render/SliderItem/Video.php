...
class Video extends Widget implements RendererInterface
{
    protected $_element;
    ...
    {
        $this->setTemplate('TemplateMonster_FilmSlider::slideritem/widget/render/slideritem/video.phtml');
        parent::_construct();
    }
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->setChild('slideritem.video.button', $buttonImage);
