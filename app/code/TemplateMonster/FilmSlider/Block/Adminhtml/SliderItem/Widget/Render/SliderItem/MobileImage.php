...
class MobileImage extends Widget implements RendererInterface
{
    protected $_element;
    ...
    {
        $this->setTemplate('TemplateMonster_FilmSlider::slideritem/widget/render/slideritem/mobile_image.phtml');
        parent::_construct();
    }
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->setChild('slideritem.mobileimage.button', $buttonImage);
